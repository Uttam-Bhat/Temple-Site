  ...
  const annualFunctions = [
    {
      ...
      name: "Ugadi",
      shortDescription:
        "Ugadhi is the first festival of the year and marks the beginning of the New Year according to our Hindu calendar, which falls on the Prathipadha Tithi of the Chaitra Maasa, and is celebrated annually in the temple with great devotion and joy.",
      expandedText:
        " All the Samaj Bandhavas gather at the temple in the evening, where the Panchanga Shravanam is performed by the pradhana archaka, followed by a Vishesha Alankara Pooja offered to Lord Venkataramana.",
    },
    {
      id: 2,
      name: "Pratistha Vardhanti",
      shortDescription:
        "Pratistha Vardhanti is celebrated on the anniversary of the re-establishment of the temple. The Punar Pratistha of the temple was performed on the Dwithiya Tithi of the Shukla Paksha in the Aashada Maasa. Therefore, every year, the Dwithiya Tithi of the Shukla Paksha in the Aashada Maasa is observed as the Pratistha Vardhanti in the temple.",
      expandedText:
        " On this special occasion, the program begins with Devatha Prarthane, followed by Ganapathi Poojana, Dwadasha Kalashabhisheka, Sanidya Havana, the Madyana Mahapooja, and Mangalarathi to the Lord. Later, Brahmana Samaradhane and Santarpane are performed. All the Samaj Bandhavas gather together, and the entire celebration is carried out with immense devotion and deep spiritual fervor.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      shortDescription:
        "Ganesh Chaturthi is celebrated every year in the temple with great devotion to honor Lord Ganesha, the remover of obstacles and the source of wisdom and prosperity. This festival falls on the Chaturthi Tithi of the Shukla Paksha in the Bhadrapada Maasa.",
      expandedText:
    ...
    },
    {
      ...
      shortDescription:
        "Satya Ganapathi Vratha is celebrated annually in the temple on the Chathurthi Tithi of the Shravana Maasa, also known as Angaraka Sankashtahara Chathurthi. The evening program is devoted to Lord Ganapathi with collective prayers and rituals.",
      expandedText:
        " The program begins with Devata Prarthane, Kalasha Sthapane, and other Vidhi-Vidhanas offered to Lord Ganapathi. Bhajana Seva is rendered by devotees to the Lord, followed by the Mahapooja performed to both Lord Ganapathi and Lord Venkataramana. Santarpane is carried out thereafter, and the entire festival is celebrated by the Samaj Bandhavas with unity, devotion, and great spiritual enthusiasm.",
    },
    {
      id: 9,
      name: "Anantha Chaturdashi (Nopi)",
      shortDescription:
        "Anantha Chaturdashi, also referred to as Nopi, is celebrated every year in the temple with deep devotion to Lord Anantha, seeking His divine blessings for protection, prosperity, and well-being. The festival falls on the Chaturdashi Tithi of the Shukla Paksha in the Bhadrapada Maasa.",
      expandedText:
        " Celebrations begin with Devatha Prarthane, followed by the Kalasha Sthapane and the Dharmika Vidhi-Vidhanas performed by the Archaka. A Vishesha Alankara is offered to Lord Venkataramana, after which the Mahapooja and Mangalarathi are performed with great devotion. Later, Prasada and Santarpane are distributed to all devotees, and it is believed that no devotee should miss this sacred Prasada. The festival is observed with devotion, unity, and joy as the Samaj Bandhavas gather to seek the divine grace of Lord Anantha.",
    },
    {
      id: 10,
      name: "Vanabhojana Utsava",
      shortDescription:
        "Vanabhojana is celebrated every year in the temple on the Bahula Panchami of the Kartika Maasa, when the Ubhaya Devaru of Naikanakatte are taken to the vana, symbolizing divine togetherness and the unity of the Samaj.",
      expandedText:
        " The program begins with Devatha Prarthane, followed by the grand procession of both deities to the vana in the Pallakki. In the vana, Dhatri Havana, Dharmika Vidhi-Vidhanas, Pooja, and Mangalarathi are performed before Prasada distribution and Santarpane take place in the serene natural surroundings. In the evening, the Lord returns to the temple in the Pallakki, blessing devotees at their doorsteps, with several Katte Poojas conducted along the route. Upon returning, Astavadhana Seva and Ratri Pooja are offered to the Lord, and the entire festival is celebrated with deep devotion, unity, and joy.",
    },
    {
      id: 11,
      name: "Bhajana Ekaha",
      shortDescription:
        "Bhajana Ekaha is observed every year in the temple on the Ekadashi Tithi of the Karthika Maasa, where devotees spend an entire day and night immersed in devotional singing and service.",
      expandedText:
        " The program begins with Devatha Prarthane and Deepa Sthapane, followed by Akhanda Bhajans performed by various Bhajana Mandalis and Paalis that continue until the next afternoon. A Vishesha Pushpalankara is offered to the Lord on both days, and the afternoon Mahapooja and Mangalarathi are followed by Prasada distribution and Santarpane. In the evening, the deities are taken out in a grand Bhajana Nagarotsava in the Pallakki, with Katte Poojas along the way. Upon returning to the temple, Bhajana Suttu and Ratri Pooja are offered to the Lord, concluding with Prasada distribution.",
    },
  ];
