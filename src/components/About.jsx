      ...
      <div className="container">
        ...
        {isExpanded && (
          <div className="about-extra">
            ...
            <p className="about-description">
              Naikanakatte is a village that is home to two temples dedicated to the same presiding deity, Lord Venkataramana, and both belong to our GSB Samaj. . These two temples are regarded as the two eyes of the GSB Samaj Bandhavas of village.
            </p>
            <p className="about-description">
              A unique and divine highlight of Naikanakatte is that during every temple Utsava, the Deities  from both temples are taken in the same Pallakki, followed by the grand Nagarotsava of the Ubhaya Venkataramana. Witnessing this sacred procession is a deeply devotional and joy-filled spiritual experience for all the Samaj Bandhavas.
            </p>
          </div>
        )}
